...
<div class="w-2/5 text-white h-12 pl-32 py-4 h-auto">
  ...
  <nav class="mt-5 px-2">
    <a href="/" class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-[#192734] text-blue-300">
  <svg class="mr-4 h-6 w-6 " stroke="currentColor" fill="none" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l9-9 9 9M5 10v10a1 1 0 001 1h3a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1h3a1 1 0 001-1V10M9 21h6"/>
  </svg>
  Home
</a>
<a href="#" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-[#192734] hover:text-blue-300">
...
<a href="#" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-[#192734] hover:text-blue-300">
...
<a href="#" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-[#192734] hover:text-blue-300">
  ...
  Lists
    ...
    <a href="{{route('my-profile')}}" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-[#192734] hover:text-blue-300">
...
<div class="flex items-center">
  <div>
    ...
    <img class="inline-block h-10 w-10 rounded-full" src="{{ Storage::url(Auth::user()->profile_pic) }}" alt="">
    @else
...
<form method="POST" class="w-[200px]" action="{{ route('logout') }}">
    @csrf
    <x-dropdown-link class="bg-blue-400 text-center mt-5 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full" :href="route('logout')"
