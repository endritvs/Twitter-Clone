...
<div class="w-2/5 text-white h-12 pl-32 py-4 h-auto">
    ...
    <nav class="mt-5 px-2">
        <a href="/"
            class="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-[#192734] text-blue-300">
        ...
        <a href="#"
            class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-[#192734] hover:text-blue-300">
