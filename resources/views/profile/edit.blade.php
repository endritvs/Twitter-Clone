                                ...
                                <form method="POST" action="{{ route('image.upload') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="flex flex-col items-center justify-center w-full">
                                        <label for="profile_pic"
                                            class="mt-4 mb-2 text-xl font-medium text-gray-700">Select a file to
                                            upload:</label>
                                        <input type="file" name="profile_pic" id="profile_pic"
                                            class="px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                                        @error('profile_pic')
                        ...
                        <div class="max-w-xl">
                            ...
                            <div class="flex flex-col items-center justify-center">
                                <form method="POST" action="{{ route('bg.upload') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="flex flex-col items-center justify-center w-full">
                                        <label for="bg_profile"
                                            class="mt-4 mb-2 text-xl font-medium text-gray-700">Select a file to
                                            upload:</label>
                                        <input type="file" name="bg_profile" id="bg_profile"
                                            class="px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm appearance-none focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent">
                                        @error('bg_profile')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
