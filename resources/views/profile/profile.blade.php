        ...
        <section class="w-3/5 border border-y-0 border-gray-800" style="max-width:600px;">
            ...
            <div>
                <div class="w-full bg-cover bg-no-repeat bg-center bg-gray-500" style="height: 200px;">
                    ...
                    @else
                    <img class="opacity-0 w-full h-full" style="background-color:gray;" src="#" alt="">
                    @endif
                </div>
                <div class="p-4">
                        ...
                        <div class="flex flex-1">
                            <div style="margin-top: -6rem;">
                                <div style="height:9rem; width:9rem;" class="md rounded-full relative avatar">
                                    ...
                                    <img class="rounded-full w-full h-full" src="{{ Storage::url(Auth::user()->profile_pic) }}" alt="">
                                    @else
                                    <img style="height:9rem; width:9rem;" class="md rounded-full relative border-4 border-gray-900" src="{{asset('images/default-profile.jpg')}}" alt="">
                                    @endif
                    ...
                    <div class="space-y-1 justify-center w-full mt-3 ml-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm leading-5 font-medium text-gray-600 lowercase">{{'@'.str_replace(' ', '', Auth::user()->name)}}</p>
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="text-gray-600 flex">
                                ...
                                <span class="flex mr-2"><svg viewBox="0 0 24 24" class="h-5 w-5 paint-icon">
                                    ...
                                    </svg> <span class="leading-5 ml-1">Joined {{date_format(Auth::user()->created_at,'F, Y')}}</span></span>
                            </div>
                        </div>
                        <div class="pt-3 flex justify-start items-start w-full divide-x divide-gray-800 divide-solid">
                            <div class="text-center pr-3"><span class="font-bold text-white">{{$followingCount}}</span><span class="text-gray-600 ml-2">Followers</span></div>
                            <div class="text-center px-3"><span class="font-bold text-white">{{$followersCount}}</span><span class="text-gray-600 ml-2">Following</span></div>
                        </div>
                    </div>
                </div>
                <hr class="border-gray-800">
                  ...
                  <div class="ml-3">
                    <p class="text-base leading-6 font-medium text-white">
                      ...
                      <span class="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">
                        ${'@' + post.user.name.replace(/\s/g, '') + ' - ' + post.created_at}
                      </span>
                    </p>
                  </div>
                </div>
